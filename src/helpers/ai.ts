...
import {
  AZEROTH_NEWS_GENERATOR_SYSTEM_PROMPT,
  AZEROTH_NEWS_GENERATOR_USER_PROMPT,
  WOLRD_NEWS_GENERATOR_SYSTEM_PROMPT,
  WOLRD_NEWS_GENERATOR_USER_PROMPT,
} from './ai.consts';

async function getPerplexityCompletion(
...
function extractMatchingLinksWithSource(
  text: string,
  links: string[],
): { source: number; link: string }[] {
